...
"""
This script generates a 3D mesh representing a bundle of 9 axons.
"""
...
ny = 14*2**resolution_factor
nz = 14*2**resolution_factor

# box mesh
mesh = BoxMesh(Point(0, 0.3, 0.3), Point(l*200, 1.7, 1.7), nx, ny, nz)
...
dir_path = 'meshes/' + str(l*200) + '_axonbundle_3d/'
