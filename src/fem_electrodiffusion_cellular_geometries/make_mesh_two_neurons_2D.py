...
# add interior domain (cell)
a = Point(35, 52)   # bottom left of interior domain
b = Point(85, 58)   # top right of interior domain
add_rectangle(mesh, subdomains, surfaces, a, b)

# add interior domain (cell)
a = Point(35, 62)   # bottom left of interior domain
b = Point(85, 68)   # top right of interior domain
add_rectangle(mesh, subdomains, surfaces, a, b)
...
dir_path = 'meshes/two_neurons_2d/'
